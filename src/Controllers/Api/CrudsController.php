...
namespace Mhbarry\LaravelResourcefy\Controllers\Api;
...
class CrudsController extends Controller
{
    public function index(Request $request) {
        $model = config('laravelresourcefy.modelsNamespace').'\\'.request('model');
        $items = $model::with([]);
    ...
    public function show(Request $request, $id) {
        $model = config('laravelresourcefy.modelsNamespace').'\\'.$request->get('model');
    ...
    public function save(Request $request, $item, $id = null) {
        ...
        foreach ($fields as $field) {
            ...
            $basePath = config('laravelresourcefy.filesPath');
            if ($type === 'image') {
